      ...
      <section id="component-1">
        <div class="component">
          <div class="form-group">
            <!-- ************************ 상품 정보 출력 **************************** -->
            <img src="resources/img/product/${review.product_image }" class="itemdt">
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="${review.product_name }" readonly>
            <!-- ************************ 리뷰 내용 작성 **************************** -->
