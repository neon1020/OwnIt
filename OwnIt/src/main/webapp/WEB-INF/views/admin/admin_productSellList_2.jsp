				...
				<div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- 검색기능 Start -->
	                        <form action="admin_productSellList_2" method="get">
							...
							<%PageInfo pageInfo = (PageInfo)request.getAttribute("pageInfo"); %>
								<nav>
									...
									<%if(pageInfo.getPageNum() > pageInfo.getStartPage()) {%>
										<li class="page-item">
											<a class="page-link" href="admin_productSellList_2?pageNum=${pageInfo.pageNum - 1}">Previous</a>
										</li>
									<%} else{ %>
									...
									<c:forEach var="i" begin="${pageInfo.startPage }" end="${pageInfo.endPage }">
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item">
													<a class="page-link" href="admin_productSellList_2?pageNum=${i }">${i }</a>
												</li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<%if(pageInfo.getPageNum() < pageInfo.getMaxPage()) {%>
										<li class="page-item">
											<a class="page-link" href="admin_productSellList_2?pageNum=${pageInfo.pageNum + 1}">Next</a>
										</li>
									<%} else{ %>
										<li class="page-item disabled">
