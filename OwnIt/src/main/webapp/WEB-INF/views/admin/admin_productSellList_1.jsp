                        ...
                        <div class="card-body">
	                        ...
	                        <div style="text-align: center;">
	                        	<div class="progress mb-3" style="height: 13px; width: 300px; margin: auto;">
                                    <div class="progress-bar bg-primary active progress-bar-striped" style="width: 50%;" role="progressbar"><span class="sr-only">60% Complete</span></div>
                                </div>
                            ...
                            <!-- 검색기능 Start -->
	                        <form action="admin_productSellList_1" method="get">
							...
							<%PageInfo pageInfo = (PageInfo)request.getAttribute("pageInfo"); %>
								<nav>
									...
									<%if(pageInfo.getPageNum() > pageInfo.getStartPage()) {%>
										<li class="page-item">
											<a class="page-link" href="admin_productSellList_1?pageNum=${pageInfo.pageNum - 1}">Previous</a>
										</li>
									<%} else{ %>
									...
									<c:forEach var="i" begin="${pageInfo.startPage }" end="${pageInfo.endPage }">
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item">
													<a class="page-link" href="admin_productSellList_1?pageNum=${i }">${i }</a>
												</li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<%if(pageInfo.getPageNum() < pageInfo.getMaxPage()) {%>
										<li class="page-item">
											<a class="page-link" href="admin_productSellList_1?pageNum=${pageInfo.pageNum + 1}">Next</a>
										</li>
									<%} else{ %>
										<li class="page-item disabled">
