...
<script>
    ...
    function changeType(type) {
		...
		document.productWriteForm.type.value = type;
		
		// 단, 선택된 브랜드가 "직접입력"이 아닐 경우 brand 입력창 잠금(readOnly 속성 적용)
		if(type == "") {
			document.productWriteForm.type.readOnly = false;
			document.productWriteForm.type.focus();
		} else {
			document.productWriteForm.type.readOnly = true;
		}
	}
