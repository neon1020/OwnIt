	          	...
	          	<table class="table">
	          		...
	          		<tr>
	          			<th>
	          				...
	          				<input type="checkbox">박스/패키지 상태에 따른 검수 기준을 확인했습니다.<br>
	          		...
	          		<tr>
	          			<th>
	          				...
	          				<a href="member_sell_form" class="btn btn-lg btn-primary btn-block mt-1" style="background: black; color: white;">
	          				판매 계속</a>
	          			</th>
	          		</tr>
	          	</table>
