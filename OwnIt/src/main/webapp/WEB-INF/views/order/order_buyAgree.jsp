	          	...
	          	<table class="table">
	          		...
	          		<tr>
	          			<th>
	          				...
	          				<input type="checkbox">박스/패키지와 상품 컨디션에 민감하시다면 검수 기준을 반드시 확인하시기 바랍니다.<br>
	          		...
	          		<tr>
	          			<th>
		          			...
		          			<a href="member_buy_form" class="btn btn-lg btn-primary btn-block mt-1" style="background: black; color: white;">
		          			구매 계속
		          			</a>
		          		</th>
	          		</tr>
