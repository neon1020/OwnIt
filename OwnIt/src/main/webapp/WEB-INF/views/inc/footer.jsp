...
<script>
  ...
  ChannelIO('boot', {
    "pluginKey": "d43cb87b-7eea-4f93-9290-2bcfd2f0dd3a", //please fill with your plugin key
    "memberId": "${sessionScope.sId }", //fill with user id
    "profile": {
      "name": "${sessionScope.sNick}", //fill with user name
      "mobileNumber": "${sessionScope.sPhone}", //fill with user phone number
    }
  });
</script>
<!-- End Channel Plugin -->    
<footer class="bg-dark text-white py-0">
	<div class="container-fluid bg-dark text-body footer mt-5 pt-2 wow fadeIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
		<div class="container py-5">
			<div class="row g-5">
				<div class="col-lg-50 col-md-6" style="padding-left: 100px;">
					<h5 class="text-white mb-4">About</h5>
						<p class="mb-2">
							...
							&nbsp;&nbsp;&nbsp;https://github.com/neon1020/OwnIt
						</p>
						<p class="mb-2">
        ...
        <div class="col-lg-50 col-md-6" style="padding-left: 200px;">
            ...
            <p class="mb-2">
            	...
            	&nbsp;&nbsp;Kim Sohee - hiyayeah502@gmail.com
            </p>
            <p class="mb-2">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
							<path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/></svg>            
            	&nbsp;&nbsp;Kim Jinsook - jim584800@gmail.com
            </p>
            <p class="mb-2">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
							<path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/></svg>            
           	 &nbsp;&nbsp;Ryu Hyejee - hyejee92@gmail.com
            </p>
            <p class="mb-2">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
							<path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/></svg>            
          	  &nbsp;&nbsp;Park Judalm - wnekfa1004@naver.com
            </p>
            <p class="mb-2">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
							<path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/></svg>            
           	 &nbsp;&nbsp;Seo seongmin - blussm@kakao.com
            </p>
            <p class="mb-2">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
							<path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/></svg>            
            	&nbsp;&nbsp;Jeong Chaeyeon - neo3111@nave.com
            </p>
        </div>
			</div>
		</div>
