										...
										<td style="font-size:14px; color: black; width: 160px; padding: 3px 0px 3px 0px; vertical-align:middle;">
											<c:choose>
			                                	...
			                                	<c:when test="${order.order_buy_gb == '3'}">
			                                		구매확정 <input type="button" value="리뷰작성" class="btn btn-outline-dark btn-sm" onclick="location.href='review_writeForm?order_buy_idx=${order.order_buy_idx}&member_idx=${order.member_idx }'">
			                                	</c:when>
