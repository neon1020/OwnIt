...
//    });
	...
	$(function(){
		...
		$.ajax({
			type: "GET",
            url: "orderBuy_ProductType_Ratio",
            dataType:"json"
            })
	    ...
	    var myChart = new Chart(ctx, {
	        ...
	        data: {
	            datasets: [{
	                data: valueList,
	                backgroundColor: [
	                    "rgba(100, 150, 210, 0.9)",
	                    "rgba(113, 165, 222, 0.9)",
	                    "rgba(131, 176, 225, 0.7)",
	                    "rgba(174, 203, 235, 0.7)",
	                    "rgba(215, 226, 237, 0.7)",
	                    "rgba(225, 236, 247, 0.5)"
	                ],
