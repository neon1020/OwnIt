  	...
  	$(function(){
		...
		$.ajax({
			...
			for(let data of dataList) {
				labelList.push(data.date);
				valueList.push(data.sales_buy);
			}
...
//  });
  ...
  $(function(){
		...
		$.ajax({
			type: "GET",
            url: "orderBuy_monthly_sales",
            dataType:"json"
            })
            .done(function(dataList) { // 요청 성공 시
			
			var labelListDate = new Array();
			var valueListBuy = new Array();
			var valueListSell = new Array();
			
			for(let data of dataList.jsonArrayBuy) {
				labelListDate.push(data.date);
				valueListBuy.push(data.sales_buy);
			}
			
			for(let data of dataList.jsonArraySell) {
				valueListSell.push(data.sales_sell);
			}
