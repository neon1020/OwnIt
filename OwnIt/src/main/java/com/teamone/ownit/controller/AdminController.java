...
//	}
	...
	public String admin_productWritePro(@ModelAttribute AdminProductVO product, Model model, HttpSession session) {
		...
		product.setImage_original_file1(fileList.get(0).get("originalFileName").toString());
		product.setImage_original_file2(fileList.get(1).get("originalFileName").toString());
		product.setImage_original_file3(fileList.get(2).get("originalFileName").toString());
		product.setImage_real_file1(fileList.get(0).get("realFileName").toString());
		product.setImage_real_file2(fileList.get(1).get("realFileName").toString());
		product.setImage_real_file3(fileList.get(2).get("realFileName").toString());
